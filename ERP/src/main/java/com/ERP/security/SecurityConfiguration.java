...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests()
				.antMatchers("/", "/list", "/service/user/", "/listproject")
				.access("hasRole('USER') or hasRole('ADMIN') or hasRole('DBA') or hasRole('Junior Engineer')")
				.antMatchers("/newuser/**", "/delete-user-*", "/addproject/**")
				.access("hasRole('ADMIN')")
				.antMatchers("/edit-user-*")
				.access("hasRole('ADMIN') or hasRole('DBA') or hasRole('Junior Engineer')")
