...
public class VendorTypeApiHandler implements RestApiHandler<VendorTypeForm> {

	@Override
	public ResponseEntity<VendorTypeForm> save(AuthTokenInfo tokenInfo, VendorTypeForm className) {

		ResponseEntity<VendorTypeForm> response = null;
		...
		try {
			response = restTemplate.postForEntity(
					ErpConstants.VENDOR_TYPE_CREATE + ErpConstants.QPM_ACCESS_TOKEN + tokenInfo.getAccess_token(),
					request, VendorTypeForm.class);
	...
	public List<LinkedHashMap<String, Object>> findAllInfo(AuthTokenInfo tokenInfo) {
		...
		System.out.println("\nTesting findAllInfo VendorType API-----------");
		RestTemplate restTemplate = new RestTemplate();
		...
		try {
			...
			if (usersMap != null) {
				...
				System.out.println(
						"=============>>>>>>>>  VendorTypeApiHandler -- findAllInfo -- usersMap : " + usersMap);
				return usersMap;
			} else {
	...
	@Override
	public ResponseEntity<VendorTypeForm> getDetailsById(AuthTokenInfo tokenInfo, Long id) {
	...
	public ResponseEntity<List> getListEntityInfo(AuthTokenInfo tokenInfo) {
		System.out.println("\nTesting getListEntityInfo VendorType API-----------");
		RestTemplate restTemplate = new RestTemplate();
