...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-12">
			...
			<c:if test="${editVendorStage == 'getVendorList'}"> --%>
				<div class="card" id="getRequestQuotationList">
					<div class="header">
 ...
 -->
									...
									<tbody>
										...
										<c:forEach items="${getEditRequestQuotationDetails}" var="requestQuotation"
											varStatus="val">


											<tr>

												<td>${requestQuotation.requestQuotationId}</td>
												<td>${requestQuotation.requestQuotationStatus}</td>
