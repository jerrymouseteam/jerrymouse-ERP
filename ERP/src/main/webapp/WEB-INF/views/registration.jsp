			...
			<div class="row">
				<div class="form-group col-md-12">
					...
					<div class="col-md-7">
						...
						<form:input type="text" path="retypePassword" id="firstName"
							class="form-control input-sm" />
						<form:input type="text" path="mobileNumber" id="firstName"
							class="form-control input-sm" />
						<form:input type="text" path="alternateNumber" id="firstName"
							class="form-control input-sm" />
						<form:input type="text" path="address" id="firstName"
							class="form-control input-sm" />
